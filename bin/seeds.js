...
const exercises = [
...

	{
		...
		description:
			'Stand tall with a tight core and make sure your feet are shoulder-width apart. Bring your hands together for balance. Step directly to the left, leaving your right foot in place. Bend the left knee and pause once the upper left thigh is parallel to the ground. Your right leg should be completely straight. Contract the hamstring muscle then push off the ground to return to the starting position. Repeat on the right side. Alternate this movement.',
		level: 'Begginer',
		bodyPart: 'Lower body',
		category: [ 'Men', 'Women' ],
		exerciseUrl: String
...

	{
		...
		description:
			'Stand straight holding a water bottle in each hand with an overhand grip. Hold the water bottles in front of your thighs with your palms of the facing your thighs. Keep your arms fully extended. This is the start position. Raise the left water bottle out and upwards, while keeping a slight bend in your elbow. Your palms must always face down for this exercise. Continue raising the water bottle until your arm is a little above parallel to the floor. Exhale as you are raising the water bottle. Pause for a count of one. Inhale and slowly lower the water bottle to the start position. As you lower the left water bottle, begin to lift the right water bottle, duplicating the movement. When both water bottles have been raised and lowered in a cycle, that is one repetition. Repeat.',
		level: 'Advanced',
		bodyPart: 'Upper body',
		category: [ 'Men', 'Women' ],
		exerciseUrl: String
...

	{
		...
		description:
			'Sit on a chair with your hands either next to your hips or slightly under the hips. Lift up onto your hands and bring your hips forward. Bend your elbows and lower your hips down, keeping shoulders down and hips close to the chair. Push back up but don’t lock your elbows and repeat.',
		level: 'Begginer',
		bodyPart: 'Upper body',
		category: [ 'Men', 'Women' ],
		exerciseUrl: String
