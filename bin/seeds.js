...
const exercises = [
	{
		...
		level: 'Beginner',
		bodyPart: 'Upper body',
		exerciseUrl: 'http://www.youtube.com/embed/N_bPELOZ0T4'
	},

	{
		...
		level: 'Intermediate',
		bodyPart: 'Upper body',
		exerciseUrl: 'http://www.youtube.com/embed/_w9IjJtFqDQ'
	},

	{
		...
		level: 'Advanced',
		bodyPart: 'Upper body',
		exerciseUrl: 'http://www.youtube.com/embed/47lfnF4iRxk'
	},

	{
		...
		level: 'Beginner',
		bodyPart: 'Full body',
		exerciseUrl: 'http://www.youtube.com/embed/98c-YrA0ROY'
	},

	{
		...
		level: 'Intermediate',
		bodyPart: 'Full body',
		exerciseUrl: 'http://www.youtube.com/embed/2GVzT1Sd_bg'
	},

	{
		...
		level: 'Advanced',
		bodyPart: 'Full body',
		exerciseUrl: 'http://www.youtube.com/embed/sc7qP0gbFjM'
	},

	{
		...
		level: 'Beginner',
		bodyPart: 'Lower body',
		exerciseUrl: 'http://www.youtube.com/embed/gkAYeOEe33U'
	},

	{
		...
		level: 'Intermediate',
		bodyPart: 'Lower body',
		exerciseUrl: 'http://www.youtube.com/embed/NIgy4oCp_Kw'
	},

	{
		...
		level: 'Advanced',
		bodyPart: 'Lower body',
		exerciseUrl: 'http://www.youtube.com/embed/sDIWqlk5rjI'
	},

	{
		...
		level: 'Beginner',
		bodyPart: 'Upper body',
		exerciseUrl: 'http://www.youtube.com/embed/I_uMNn8WBWk'
	},

	{
		name: 'Plank Switches',
		description:
			'Start in the plank position with your elbows shoulder-width apart.Press yourself up from the floor one arm at a time into a push-up, maintaining your body in a straight line. Slowly return to the starting plank position the same way, one arm at a time. Repeat the movement alternating sides.',
		level: 'Intermediate',
		bodyPart: 'Upper body',
		exerciseUrl: 'http://www.youtube.com/embed/lOSgvVrvnCM'
	},

	{
		...
		level: 'Advanced',
		bodyPart: 'Upper body',
		exerciseUrl: 'http://www.youtube.com/embed/FogEixvbdLU'
	},

	{
		...
		level: 'Beginner',
		bodyPart: 'Lower body',
		exerciseUrl: 'http://www.youtube.com/embed/qyw_m7g4oVg'
	},
...

	{
		...
		level: 'Beginner',
		bodyPart: 'Upper body',
		exerciseUrl: 'http://www.youtube.com/embed/F6TxCdnEUP0'
	},

	{
		name: 'Ground Supermans',
		description:
			'Lie face down on a mat, with your arms fully extended above your head and your legs fully extended behind you. Lift your chest by arching your back. Move your arms backwards and forward, then repeat.',
		level: 'Intermediate',
		bodyPart: 'Full body',
		exerciseUrl: 'http://www.youtube.com/embed/-VzhQDlIOjo'
	},

	{
		name: 'Supermans / Extended Arms & Legs Lifts',
		description:
			'Lie face down on a mat, with your arms fully extended above your head and your legs fully extended behind you. Lift your chest, arms and legs off the floor by arching your back. Only the tops of your quads and your lower abdomen should be in contact with the floor. Move your arms backwards and forward, then repeat.',
		level: 'Advanced',
		bodyPart: 'Upper body',
		exerciseUrl: 'http://www.youtube.com/embed/_Iouhn4M8t8'
	}
];
